...
Route::get('/sales', [SalesController::class, 'index'])->name('sales.index')->middleware('can:view-sales');
Route::get('/sales/{sales}', [SalesController::class, 'show'])->name('sales.show')->middleware('can:view-sales');

Route::group(['middleware' => ['can:manage-sales']], function () {
