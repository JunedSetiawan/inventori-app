 <?php
    ...
    Route::get('/inventory', [InventoriController::class, 'index'])->name('inventory.index')->middleware('can:view-inventory');
    Route::group(['middleware' => ['can:manage-inventory', 'auth']], function () {
